...
# ---------- Page & menu: minimal, no extra options ----------
st.set_page_config(
...
# (Optional belt-and-braces CSS: hide any lingering deploy button & element toolbars)
st.markdown("""
<style>
...
try:
    ...
    # (Static) quick preview without toolbar
...
# ---------- Inference (no predictions table shown, not required) ----------
# We only compute predictions to evaluate metrics when ground truth is present.
...
# ---------- Required Feature #3: Evaluation Metrics (if target present) ----------
if has_target:
